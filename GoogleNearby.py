# Form implementation generated from reading ui file 'GoogleNearby.ui'
#
...
class Ui_GoogleNearby(object):
    ...
    def setupUi(self, GoogleNearby):
        global window, app, window_position
        GoogleNearby.setObjectName("GoogleNearby")
        GoogleNearby.setFixedSize(800, 600)
        GoogleNearby.setStyleSheet("background-color: black;")
        GoogleNearby.setWindowTitle("GoogleNearby")
        if window_position is not None:
            GoogleNearby.move(window_position)
        window = GoogleNearby
        ...
        self.nam.get(QNetworkRequest(QUrl("https://raw.githubusercontent.com/"
                                          "T3tsuo/GoogleNearby/main/cache/maps.ico")))
        self.centralwidget = QtWidgets.QWidget(parent=GoogleNearby)
        ...
        self.title.setText("GoogleNearby")
        self.title.adjustSize()
        self.title.move(GoogleNearby.width() // 2 - self.title.width() // 2,
                        GoogleNearby.height() // 4 - self.title.height())
        self.person = QtWidgets.QComboBox(parent=self.centralwidget)
        self.person.setGeometry(QtCore.QRect(GoogleNearby.width() // 2 - 170 // 2,
                                             GoogleNearby.height() // 2 - 20, 170, 40))
        ...
        self.start_button.setGeometry(QtCore.QRect(GoogleNearby.width() // 2 - 70,
                                                   GoogleNearby.height() * 2 // 3 - 50 // 2, 140, 50))
        ...
        self.stop_button.setGeometry(QtCore.QRect(GoogleNearby.width() // 2 - 70,
                                                  GoogleNearby.height() * 2 // 3 - 50 // 2, 140, 50))
        ...
        self.is_running.move(self.start_button.x() + self.start_button.width() // 2 - self.is_running.width() // 2,
                             GoogleNearby.height() * 3 // 5 - self.is_running.height())
        GoogleNearby.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=GoogleNearby)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 26))
        self.menubar.setObjectName("menubar")
        GoogleNearby.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=GoogleNearby)
        self.statusbar.setObjectName("statusbar")
        GoogleNearby.setStatusBar(self.statusbar)
        QtCore.QMetaObject.connectSlotsByName(GoogleNearby)
...
if __name__ == "__main__":
    ...
    GoogleNearby = QtWidgets.QMainWindow()
    ui = Ui_GoogleNearby(app, window_position)
    ui.setupUi(GoogleNearby)
    GoogleNearby.show()
    sys.exit(app.exec())
